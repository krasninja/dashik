...
internal sealed class LocalWidgetsProvider : IWidgetsProvider
{
    ...
    private static readonly ResourceInclude _resourceInclude = new(new Uri("avares://Dashik.Host/Resources/FontAwesome.axaml"))
    {
        Source = new Uri("avares://Dashik.Host/Resources/FontAwesome.axaml")
    };
